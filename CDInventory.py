...
class FileProcessor:
    ...
    def write_file(file_name, table):
        """Function to write the CD inventory data in memory to a text file, replacing what is already in the file.

        Writes the data from the list of dicts table in memory into a text file.
        Each dictionary row in the table is written to one line in the file.
